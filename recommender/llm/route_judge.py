...
class RouteIntentJudge:
    ...
    def judge(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            "5. ELIMINATION RULE — check each candidate function: does the student have ANY concrete "
            "evidence of this career direction? If a function has ZERO supporting evidence (no relevant "
            "job titles, no relevant skills, no relevant education), ELIMINATE it even if the classifier "
            "ranked it highly. Example: a student with only admin/project-coordination experience and "
            "zero engineering/software/hardware skills should NOT be classified as technology/engineering.\n"
            "6. DEGREE MAPPING — use the student's major as a directional signal: Psychology/Biology → "
            "healthcare; History/American Studies/Political Science → education or social-service; "
            "Criminal Justice → social-service or legal; English/Communications → arts-media or education.\n"
            "7. For VERY THIN resumes (<5 clear skills), prefer functions with broad entry-level job pools "
