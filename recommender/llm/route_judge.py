...
class RouteIntentJudge:
    ...
    def judge(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            "5. For VERY THIN resumes (<5 clear skills), prefer functions with broad entry-level job pools "
            "(education, healthcare, support, sales, ops, food-service) over narrow ones "
            "(legal, engineering, arts-media, science). This ensures the student gets useful recommendations "
            "rather than being matched to jobs they can't qualify for."
        )
        user_prompt = (
